...
php-bake-all: ## Bake all PHP images
	@PHP81_MINOR=$(call get_php_minor,8.1) PHP82_MINOR=$(call get_php_minor,8.2) PHP83_MINOR=$(call get_php_minor,8.3) \
...
PHONY += php-bake-83
php-bake-83: BAKE_FLAGS := --pull --progress plain --no-cache --load --set *.platform=linux/$(CURRENT_ARCH)
php-bake-83: ## Bake all PHP images locally
	PHP83_MINOR=$(call get_php_minor,8.3) docker buildx bake -f php/docker-bake.hcl $(BAKE_FLAGS) php-83
