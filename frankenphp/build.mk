...
run-frankenphp-tests:
	$(call step,Run tests in druidfi/frankenphp:1.10.1-php8.4)
	@docker run --rm -t -v $(CURDIR)/tests/scripts:/app/scripts druidfi/frankenphp:1.10.1-php8.4 /app/scripts/tests_symfony.sh
	$(call step,Run tests in druidfi/frankenphp:1.10.1-php8.5)
	@docker run --rm -t -v $(CURDIR)/tests/scripts:/app/scripts druidfi/frankenphp:1.10.1-php8.5 /app/scripts/tests_symfony.sh
